    ...
    <section class="py-16 md:py-20 bg-paper">
      <div class="max-w-5xl mx-auto px-4 md:px-6 space-y-16">
        ...
        <div v-for="(flow, fi) in flows" :key="flow.id">
          <div class="mb-8">
            <div class="text-xs font-mono uppercase tracking-wider text-gold-dark mb-2">Method {{ fi + 1 }}</div>
        ...
        <div class="rounded-xl border border-gold/40 bg-gold/5 p-5 flex items-start gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-slate">All records are secure, time-stamped, and cannot be edited once entered. Staff overrides are logged with identity and timestamp for complete transparency.</p>
          </div>
        </div>
      </div>
    </section>
